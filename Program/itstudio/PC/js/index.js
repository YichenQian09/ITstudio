   ...
   /* if(hwRatio>886/1900)
    ...
    $(window).resize(function(){
        ...
        if($(window).width()<1600)
        {
            ...
            for(var i=0;i<6;i++)
            {
                $(".change-member:eq("+i+")").css({
                    "width":26*Math.ceil(everyyearData[i].length/4)
                });
            }
        }
        else
        {
            ...
            {
                $(".change-member:eq("+i+")").css({
                    "width":29*Math.ceil(everyyearData[i].length/4)
                });
            }
        }
    ...
    function appendFirstpage(){
        for( theYear=0;theYear<6;theYear++)
        {
            ...
            memberContainer=thisyearContainer.find(".member-container");
            var countPage=Math.ceil(everyyearData[theYear].length/4);
            //计算每年有几页
            if($(".real-container").width()>=1600)
            {
                thisyearContainer.find(".change-member").css({
                    "width":29*countPage
                });
            }
            else{
